...
# 设置画节点用的盒子的样式
decisionNode = dict(boxstyle="sawtooth", fc="lightyellow", ec='gold')
leafNode = dict(boxstyle="round4", fc="thistle", ec='tomato')
# 设置画箭头的样式
arrow_args = dict(arrowstyle="<-", ec='lightskyblue')
